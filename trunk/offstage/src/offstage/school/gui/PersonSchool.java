...
public void initRuntime(FrontApp xfapp, Statement st, int entityid) throws SQLException
{
	...
	JoinedSchemaBufDbModel enrollSb = new JoinedSchemaBufDbModel(null, new TableSpec[] {
			new TableSpec(app.getSchema("enrollments")),
			new TableSpec(app.getSchema("courseids"))
		});
	enrollSb.setWhereClause("enrollments.courseid = courseids.courseid and courses.termid = " +
		SqlInteger.sql((Integer)terms.getValue()));
	enrollments.setModelU(enrollSb.getTableModel(),
		new String[] {"Name", "Day", "Start", "Finish", "Role", "StartDate", "EndDate", "Enrolled"},
		new String[] {"courseids_name", "courseids_tstart", "courseids_tnext", "enrollments_courserole"
		new String[] {"Name", "Day", "tstart", "tnext", "role", "dstart", "dend", 
	enrollSb.doSelect(st);
	
			persons.entityid = phones.entityid and persons.lastname like '%Fisch%'");
	...
	TableSpec[] spec = new TableSpec[] {
		new TableSpec(fapp.getSchemaSet().get("enrollments")),
		new TableSpec(fapp.getSchemaSet().get("courseids"))
	};
